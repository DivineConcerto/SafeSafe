...
class LoadImagesAndLabelsAndMasks(LoadImagesAndLabels):  # for training/testing
    ...
    def __init__(
        ...
        """Initializes the dataset with images, label, and mask loading capabilities for training/testing."""
        super().__init__(
            path,
            img_size,
            batch_size,
    ...
    def __getitem__(self, index):
        """Returns a transformed item from the dataset at the specified index, handling indexing and images weighting."""
    ...
    def load_mosaic(self, index):
        """Loads 1 images + 3 random images into a 4-images YOLOv5 mosaic, adjusting labels and segments accordingly."""
        labels4, segments4 = [], []
        s = self.img_size
